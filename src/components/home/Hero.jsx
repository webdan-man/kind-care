        ...
        <div className="w-full max-w-[1920px] px-[16px] max-md:px-[8px] mx-auto flex flex-row items-center max-md:flex-col">
            <div
                ...
                <div className="flex flex-col w-full items-start max-w-[557px] max-md:max-w-none max-md:items-center">
                    <h1 className="h1 text-[rgba(255,255,255,1)] leading-[50px] max-md:text-center max-md:leading-[37px]">Տնային Խնամքի<br/>Ծառայություն</h1>
                    <p className="p6 mt-[12px] text-[rgba(255,255,255,1)] max-md:mt-[15px] max-md:text-center">Բարի Խնամքը ապահովում է անվտանգ և հետևողական խնամք ձեր սիրելիի համար, որը մատուցվում է տանը՝ հարմարավետ և թափանցիկ:</p>
