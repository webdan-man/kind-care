...
const items = [
    {
        ...
        text: "Մեր թիմը պատրաստ է շուրջօրյա խնամքի ծառայություն իրականացնել ձեր հիվանդին",
        img: {
            src: '/health/time.svg',
            alt: 'time'
        }
    },
    {
        ...
        text: "Կարճ հատվածում մենք խնամել ենք հազարավոր մարդկանց, որոնք ապաքինվել և վերադառցել են ինքնուրույն կյանքի",
        img: {
    ...
    {
        title: "Ճկուն գներ",
        text: "Սակագնային համակարգը ճկուն է կախված հիվանդի վիճակից, գտնվելու վայրից և ժամերի քանակից",
        img: {
